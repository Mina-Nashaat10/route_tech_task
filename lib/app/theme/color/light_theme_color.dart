...
class LightThemeColor extends ThemeColorInterface {
  ...
  @override
  Color get secondary    => const Color(0xFF050505);

  @override
  Color get grey         => const Color(0xFF65676B);
  ...
  @override
  Color get blue         => const Color(0xFF4996CC);
}